    ...
    <div className="p-6 w-full h-full flex flex-col gap-4 ">
      ...
      <div className=" flex-grow grid grid-cols-4 grid-rows-3 gap-5 rounded-xl">
        <div className="bg-white border-t-8 shadow-xl border-primary  col-span-3 row-span-1 rounded-xl">
          ...
          <div className="w-full p-3 flex items-center gap-x-2 text-primary font-medium">
            <FiAlertCircle />
            <span>Yapım aşamasında!</span>
          </div>
        </div>
        <div className="bg-white border-t-8 shadow-xl border-primary col-span-1 row-span-4 rounded-xl">
        ...
        <div className="bg-white border-t-8 shadow-xl border-primary row-span-3 rounded-xl">
          <div className="w-full rounded-t-xl  p-3 border-b flex justify-between items-center">
            ...
            <span className="font-semibold text-secondary">
              {expenses
                .reduce((total, expenses) => total + expenses.expensesAmount, 0)
                .toLocaleString("tr-TR", {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
                })}
        ...
        <div className=" bg-white border-t-8 shadow-xl border-primary row-span-3 col-span-2 rounded-xl">
          <div className="w-full rounded-t-xl  p-3 border-b">
            <span className="font-semibold text-primary flex gap-x-2 items-center">
              <TbTarget />
              Aktif Hedeflerim
            ...
            {goals.length > 0 ? (
              <div className="flex flex-col gap-1 w-full border rounded-md ">
                <div className="w-full grid grid-cols-4  place-items-center py-2 bg-zinc-100 rounded-t-md">
                  ...
                  <span className="text-xs uppercase">Hedefe Kalan Tutar</span>
                  ...
                  {goals.map((goal) => (
                    <div key={goal.goalID} className="w-full  rounded-md ">
                      <div className="w-full grid grid-cols-4  place-items-center py-2  rounded-md">
                        ...
                        <span className="text-sm">
                          {(goal.goalAmount - goal.goalAccount).toLocaleString(
                            "tr-TR",
                            {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
